    ...
    describe "Advent of Code" $ do
      ...
      describe "day 15" $ do
        ...
        it "returns outcome of the combat with increased attack power of elves" $ do
          ...
          file_2 <- readFile "test/day15-example-1-round-2.txt"
          file_3 <- readFile "test/day15-example-1-round-3.txt"
          file_5 <- readFile "test/day15-example-1-round-5.txt"
          file_6 <- readFile "test/day15-example-1-round-6.txt"
          file_7 <- readFile "test/day15-example-1-round-7.txt"
          file_10 <- readFile "test/day15-example-1-round-10.txt"
          ...
          let day15map = Day15.buildMap $ lines file
              ...
              round_2_map = Day15.printMap $ Day15.buildMap $ lines file_2
              round_3_map = Day15.printMap $ Day15.buildMap $ lines file_3
              round_5_map = Day15.printMap $ Day15.buildMap $ lines file_5
              round_6_map = Day15.printMap $ Day15.buildMap $ lines file_6
              round_7_map = Day15.printMap $ Day15.buildMap $ lines file_7
              round_10_map = Day15.printMap $ Day15.buildMap $ lines file_10
              ...
              round_2 = fst $ head $ List.drop 1 $ example_1_rounds
              round_3 = fst $ head $ List.drop 2 $ example_1_rounds
              round_5 = fst $ head $ List.drop 4 $ example_1_rounds
              round_6 = fst $ head $ List.drop 5 $ example_1_rounds
              round_7 = fst $ head $ List.drop 6 $ example_1_rounds
              round_10 = fst $ head $ List.drop 9 $ example_1_rounds
          ...
          Day15.printMap round_2 `shouldBe` round_2_map
          Day15.printMap round_3 `shouldBe` round_3_map
          Day15.printMap round_5 `shouldBe` round_5_map
          Day15.printMap round_6 `shouldBe` round_6_map
          Day15.printMap round_7 `shouldBe` round_7_map
          Day15.printMap round_10 `shouldBe` round_10_map
