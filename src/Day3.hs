...
data Rectangle = Rectangle {i ::Int,
                            x :: Int,
                            y :: Int,
                            w :: Int,
                            h :: Int} deriving (Eq, Show)
...
overlap (Rectangle _ x1 y1 w1 h1) (Rectangle _ x2 y2 w2 h2) = let x1p = x1 + w1 - 1
                                                                  y1p = y1 + h1 - 1
                                                                  x2p = x2 + w2 - 1
                                                                  y2p = y2 + h2 - 1
